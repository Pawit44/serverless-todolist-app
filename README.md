...
|-------------|-------------|---------------|
| B6606138 | นายธนพล สงกล้า | App Development |
| B6609535 | นางสาวมุธิตา สิงห์แก้ว | Terraform, Ansible |
| B6617646 | นายภาวิฒ ฉ่ำเสนาะ | Jenkins, Docker , Git |
...
Developer
 ...
 GitHub ──── webhook ────▶ [ Jenkins CI/CD Pipeline ]
                             ...
                             ▼
┌───────────┐     ┌──────────────┐     ┌──────────────┐     ┌──────────┐
│1. Checkout│ ──▶ │2. Build & Test│ ──▶ │3. Docker Build│ ──▶ │4. Push Hub│ ──▶ Docker Hub
└───────────┘     └──────────────┘     └──────────────┘     └──────────┘     • pawit44/todo-frontend:vX / :latest
            _____________________________________________________│           • pawit44/todo-backend:vX / :latest
            ▼
┌───────────────────────┐     ┌──────────────────────┐     ┌───────────────────────┐
│5. Provision (Terraform)│ ──▶ │6. Configure (Ansible)│ ──▶ │7. Deploy to Kubernetes│
└───────────────────────┘     └──────────────────────┘     └───────────────────────┘
                                                                       │
                                                                       ▼
                                                              Kubernetes Cluster
 ...
 │  [Backend]          [Backend]                                                               │
 │                                                                                             │
 │  Service: todo-service  (NodePort :30080 web / :30081 api)                                  │
